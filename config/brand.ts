...
export const BRAND: BrandConfig = {
  businessName: "Choice Jewellers",
  tagline: "Your Trusted Jewellery Store in Changanassery",
  description:
    "Choice Jewellers is Changanassery's trusted destination for gold, diamond and silver jewellery. Serving Changanassery and surrounding areas with timeless craftsmanship for every celebration — from weddings and festivals to everyday elegance.",
  ...
  address: "Central Junction, Karukachal - Changanacherry Rd, near Hotel Anand, Changanassery, Kerala 686101",
  city: "Changanassery",
  state: "Kerala",
  pincode: "686101",
  ...
  mapsLink:
    "https://share.google/DfgKcY1h1C1lKU06S",
  ...
  seo: {
    title: "Choice Jewellers | Gold & Diamond Jewellery in Changanassery",
    description:
      "Choice Jewellers — Changanassery's premier jewellery store. Exquisite gold, diamond and silver collections for every occasion. Visit us in Changanassery, Kerala.",
    keywords: [
      "Choice Jewellers",
    ...
    canonical: "https://choice-jewellers-changanassery.vercel.app",
  ...
  whatsappMessage:
    "Hello Choice Jewellers, I'd like to know more about your jewellery collections.",
};
